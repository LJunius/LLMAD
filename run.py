...
def parse_args():
    ...
    arg_parser.add_argument('--infer_data_path', type=str, default="data/AIOPS_hard",required=False)
    arg_parser.add_argument('--retreive_data_path', type=str, default="data/AIOPS",required=False)
    arg_parser.add_argument('--sub_company', type=str, default="real",required=False)
    arg_parser.add_argument('--model_engine', type=str, default="gpt-4-1106-preview", required=False)
    arg_parser.add_argument('--model_path', type=str, default="model/Llama-2-70b-hf", required=False)
    arg_parser.add_argument('--num_gpus', type=int, default=4, required=False)
    arg_parser.add_argument('--window_size', type=int, default=400, required=False)
    arg_parser.add_argument('--test_ratio', type=float, default=0.05, required=False)
    arg_parser.add_argument('--trans_alpha', type=int, default=95, required=False)
    arg_parser.add_argument('--trans_beta', type=float, default=0, required=False)
    arg_parser.add_argument('--retreive_ratio', type=float, default=0.50, required=False)
    arg_parser.add_argument('--prompt_mode', type=int, default=13, required=False)
    arg_parser.add_argument('--result_save_dir', type=str, default='LLM_AD/GPT_AD_exp', required=False)
    arg_parser.add_argument('--run_name', type=str, default='KPI_hard_5_prompt_13_win_400_beta0alpha95_p1n1_retall_0114_test', required=False)
    arg_parser.add_argument('--retrieve_positive_num', type=int, default=1, required=False)
    arg_parser.add_argument('--use_positive', action='store_false', default=True, required=False)
    arg_parser.add_argument('--retrieve_negative_num', type=int, default=1, required=False)
    arg_parser.add_argument('--use_negative', action='store_false', default=True, required=False)
    arg_parser.add_argument('--retrieve_negative_len', type=int, default=800, required=False)
    arg_parser.add_argument('--retrieve_negative_overlap', type=int, default=0, required=False)
    arg_parser.add_argument('--retrieve_database_ratio', type=float, default=0.1, required=False)
    arg_parser.add_argument('--run_only_anomaly', type=bool, default=False, required=False)
    arg_parser.add_argument('--overlap', type=bool, default=False, required=False)
    arg_parser.add_argument('--cross_retrieve', type=bool, default=True, required=False)
    arg_parser.add_argument('--with_value', type=bool, default=False, required=False)
    arg_parser.add_argument('--dist_div_len', type=bool, default=False, required=False)
    arg_parser.add_argument('--delete_zero', type=bool, default=False, required=False)
    arg_parser.add_argument('--interpolate_zero', type=bool, default=False, required=False)
    arg_parser.add_argument('--cost_analysis', type=bool, default=False, required=False)
