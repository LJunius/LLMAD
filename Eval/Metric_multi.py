...
def parse_args():
    ...
    arg_parser.add_argument('--path', type=str, default="result/WSD_5_prompt_79_win_400_beta0alpha95_p2n1_rate10_crossp_delete_zero_0510",required=False)
